<?php  
            ...
            require '../../bundle/auth/src/Exception.php';
            require '../../bundle/auth/src/PHPMailer.php';
            require '../../bundle/auth/src/SMTP.php';
            ...
            <table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0;mso-table-rspace:0"><tr><td class="pad" style="padding-bottom:5px;text-align:center;width:100%;padding-top:24px">
                    ...
                    <td class="pad" style="padding-top:8px;width:100%;padding-right:0;padding-left:0">
                        ...
                        <div style="color:#848b9d;direction:ltr;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;font-size:12px;font-weight:400;letter-spacing:0;line-height:150%;text-align:left;mso-line-height-alt:18px">
                            <p style="margin:0"><a  style="text-decoration: none; color: #848b9d;" rel="noopener">Unsubscribe</a></p></div>
                    </td>
        ...
        <td class="column column-2" width="58.333333333333336%" style="mso-table-lspace:0;mso-table-rspace:0;font-weight:400;text-align:left;padding-left:24px;padding-right:24px;vertical-align:top;border-top:0;border-right:0;border-bottom:0;border-left:0">
            <table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0;mso-table-rspace:0;word-break:break-word"><tr><td class="pad" style="padding-top:24px">
                        <div style="color:#848b9d;direction:ltr;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;font-size:12px;font-weight:400;letter-spacing:0;line-height:180%;text-align:left;mso-line-height-alt:21.6px">
                                ...
                                <p style="margin:0">'.$parent.' license number: '.$license_num.'</p>
                        ...
                        <p style="margin:0">Registered address: '.$address.', '.$country.'</p>
                        ...
                        <div style="color:#848b9d;direction:ltr;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;font-size:12px;font-weight:400;letter-spacing:0;line-height:120%;text-align:left;mso-line-height-alt:14.399999999999999px">
                            <p style="margin:0">
                                <a  style="text-decoration: none; color: #0c34f0;" rel="noopener">Contact info</a></p></div>
                    </td>
                  ...
                  <p style="margin:0">&#169; 2024 '.strip_tags($platform_name).'</p>
                        ...
                        <div class="alignment" style="text-align:left">
                            <table class="social-table" width="229.03030303030303px" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0;mso-table-rspace:0;display:inline-block"><tr><td style="padding:0 14px 0 0"><a ><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-color/facebook@2x.png" width="32" height="32" alt="Facebook" title="Facebook" style="display:block;height:auto;border:0"></a></td>
                                    <td style="padding:0 14px 0 0"><a ><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/ae52a6e2-ca6a-4d8e-8944-532f952aae85/becc2140-3d78-11ed-a765-9677b225863f/Twitter%20Icon_1.png" width="32" height="32" alt="Twitter" title="Twitter" style="display:block;height:auto;border:0"></a></td>
                                    <td style="padding:0 14px 0 0"><a ><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-color/telegram@2x.png" width="32" height="32" alt="Telegram" title="Telegram" style="display:block;height:auto;border:0"></a></td>
                                    <td style="padding:0 14px 0 0"><a ><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-color/instagram@2x.png" width="32" height="32" alt="Instagram" title="Instagram" style="display:block;height:auto;border:0"></a></td>
                                    <td style="padding:0 14px 0 0"><a ><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/ae52a6e2-ca6a-4d8e-8944-532f952aae85/becc2140-3d78-11ed-a765-9677b225863f/Youtube%20Icon.png" width="31.03030303030303" height="32" alt="Youtube" title="Youtube" style="display:block;height:auto;border:0"></a></td>
