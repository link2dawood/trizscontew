...
<div style="display: none;">Join the most trusted and secure trading platform in the world</div>
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <h1><a href="#" style="color: #2F7AEA;">'.$name.'</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				...
            				<h3>Join the most trusted and secure trading platform in the worldt</h3>
            				<p>Verification Code: <span style="color: #000000; font-weight: bold;">'.$msg.'</span></p>
            			</div>
            		</td>
            	</tr>
            </table>
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
        ...
        <tr>
          <td class="bg_light" style="text-align: center;">
          	<!-- <p>No longer want to receive this email? You can <p style="color: rgba(0,0,0,.8);">Unsubscribe here</p></p> -->
          </td>
        </tr>
      </table>
