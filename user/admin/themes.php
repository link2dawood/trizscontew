...
<head>
  ...
  <title>BitMerchants | Themes</title>
  <!-- Favicon icon -->
...
<body>
  ...
  <script type="module" defer src="<?php echo($js)?>themes.js"></script>
  <script src="css/vendor/assets/libs/jquery/dist/jquery.min.js"></script>
