...
<head>
  ...
  <title>BitMerchants | Declined Withdrawals</title>
  <!-- Favicon icon -->
      ...
      <div class="container-fluid" id="dashboard">
        ...
        <div class="row py-4">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Declined Withdrawals</h4>

                     <?php foreach (glob('withdrawal_log/declined_withdrawal.php') as $declined_withdrawal){include_once $declined_withdrawal;}?>
