...
<head>
  ...
  <title>BitMerchants | Backup</title>
  <!-- Favicon icon -->
                    ...
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="wrapper">
    <article class="codepen__product--card">
        <div class="card__background">
            <i class="codepen__logo fab fa-codepen"></i>
        </div>
        <header class="header header--primary">
            <h1 class="heading logo__showcase">
                <a href="#" class="logo">
                    <h2 style="color: #fff;">DeGiant Remote Backup</h2>
                </a>
            </h1>
        ...
        <main class="main__content">
            <ul class="features__list">
                ...
                <li class="feature">
                    ...
                    <p class="text">Keep your settings and users' data permanently saved on the cloud</p>
                </li>
                <li class="feature">
                    <span class="icon">
                        <i class="fas fa-check"></i>
                    </span>
                    <p class="text">You never have to click a button again as it auto backsup everyday as long as you log in</p>
                </li>
                <li class="feature">
                    <span class="icon">
                        <i class="fas fa-check"></i>
                    </span>
                    <p class="text" style="font-weight: 500;">Your hosting or server is dead? Don't worry just reinstall your script anywhere else and restore all your data</p>
                </li>
              
            </ul>
            <article class="price backup-info">
...
<div class="restore-area text-center">
                                   
                                    <button type="update" class="btn bg-dark text-white restore-btn">Restore Backup<i class="icon-paperplane ml-2"></i></button>
                                  </div>
...
<!-- 
  ...
  <script type="module" defer src="<?php echo($js)?>backup.js"></script>
  <script src="css/vendor/assets/libs/jquery/dist/jquery.min.js"></script>
