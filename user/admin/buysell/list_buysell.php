            ...
            mysqli_stmt_close($stmt);
                    ...
                    if($result = mysqli_query($dbconnected, $sql)){
                        ...
                        if($rowCount > 0){
                                      ...
                                      <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                                        <thead>
                                          <tr>
                                            ...
                                            <th style="font-weight: bold !important">Crypto</th>
                                            <th style="font-weight: bold !important">Payment Mode</th>
                                          ...
                                          <td><a href="#" data-toggle="modal" data-target="#responsive-modalUser56'.$index.'" title="click to view details">'.$email.'</a></td>
                                           ...
                                           <td style="color: #8F3739"><span
                                            ...
                                            <td>
                                              ...
                                              <form action="deposit_log/approved_deposit.php" method="POST" class='.$hide.'>    
                                              <div class="list-icons">
                                                <div class="dropdown">
                                                  ...
                                                  <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="buysell/conf_buysell?status=Approved&&id='.$id.'&&amount='.$payment_mode.'&&email='.$email.'"> <span class="iconify nav__icon"
                                                        data-icon="mdi-cash-check"></span>Approve request</a>
                                                    <a class="dropdown-item" href="buysell/conf_buysell?status=Declined&&id='.$id.'&&amount='.$payment_mode.'&&email='.$email.'"> <span class="iconify nav__icon"
                            ...
                            echo "<p class='lead'><em>No trades at the moment.</em></p>";
                        }
                    } else{
