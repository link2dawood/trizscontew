...
<head>
  ...
  <title>BitMerchants | Registered Users</title>
  <!-- Favicon icon -->
          ...
          <ul class="navbar-nav float-right">
            <li class="nav-item dropdown dropdown-user mr-3 mt-1">
              <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                <span class="d-inline-block pt-1"><?php echo $_SESSION['email']; ?> </span>
            ...
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Registered Users</h4>
                  ...
                  <?php foreach(glob('users/reg_users.php') as $users){include_once $users;}?>

                  
                  <!-- modal content for user info -->
                        <div id="responsive-modalUser56<?php echo($index);?>" class="modal fade" tabindex="-1" role="dialog"
                              ...
                              <div class="modal-body">
                                <form action="#" method="post">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                      <div class="input-group">
                                       <input type="text" name="Zip" value="<?php echo $zip_code;?>"
                                          class="form-control">
                                      </div>
                                    </div>
                                  </div>
                                    ...
                                    <div class="col-lg-10">
                                      <div class="input-group">
                                       <input type="text" name="address" step="any" max-length="10" value="<?php echo($address);?>"
                                          class="form-control">
                                      </div>
                                    </div>
                                  </div>
