<?php 
session_start();  
header("location: running-investment");
?>
...
<head>
  ...
  <title>BitMerchants | Completed Investment</title>
  <!-- Favicon icon -->
      ...
      <div class="container-fluid" id="dashboard">
        ...
        <div class="row py-4">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Completed Investment</h4>

                     <?php foreach (glob('investment/completed_investment.php') as $completed_investment){include_once $completed_investment;}?>
