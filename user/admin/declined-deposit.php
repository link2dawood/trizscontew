...
<head>
  ...
  <title>BitMerchants | Declined Deposits</title>
  <!-- Favicon icon -->
      ...
      <div class="container-fluid" id="dashboard">
        ...
        <div class="row py-4">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Declined Deposits</h4>

                   <?php foreach (glob('deposit_log/declined_deposit.php') as $declined_deposit){include_once $declined_deposit;}?>
