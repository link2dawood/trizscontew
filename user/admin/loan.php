...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid" id="dashboard">
        ...
        <!-- <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">All users who have completed verification (KYC)</h4>
                          <h5 class="card-title">Select a user to see details, including uploaded document</h5>
                        </div>
        </div> -->
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div style="display: flex; justify-content: space-between;">
                            <div>
                            <h3>Loan (<span class="feature-stat" style="color: #2F7AEA;">...</span>)</h3>

                           

                            <div class="form-group row p-2" style="background: #14161A;">
                              <label class="col-form-label col-lg-3 text-white font-16">Loan parameters</label>
                              <div class="col-lg-9">
                                <button type="update" id="loan-set-btn" class="btn bg-white text-black update-btn">Update</button>
                                <!-- <p style="font-size: 13px; color: #fff;">Activate Loan feature on this platform</p> -->
                              </div>
                            </div>

                            <h4 class="card-title">All users who have applied for a loan</h4>
                            <h5 class="card-title">Approving a loan request automatically adds loan amount to user's USDT balance</h5>
                            </div>
                            <div>
                              <!-- <p>Set restictions for unverified users:</p> -->
                                    ...
                                    <?php foreach(glob('loan_log/list_loan.php') as $users){include_once $users;}?>
                                  </div>
                      </div>
  ...
  <script type="module" defer src="<?php echo($js)?>adminLoan.js"></script>
  <script src="css/vendor/assets/libs/jquery/dist/jquery.min.js"></script>
