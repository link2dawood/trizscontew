...
<head>
  ...
  <title>BitMerchants | Referrals</title>
  <!-- Favicon icon -->
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div style="display: flex; justify-content: space-between;">
                            <div>
                            <h4 class="card-title">All referral earnings by users on the platform</h4>
                            <h5 class="card-title">To manage your referral settings, go to 'Setup'.</h5>
                            <h6>Referers will only earn on the crypto asset deposited by their referees.</h6>
                            </div>
                            <div>
                                    ...
                                    <?php foreach(glob('users/ref_earns.php') as $users){include_once $users;}?>
                                  </div>
                      </div>
