...
session_start();
 ...
 foreach (glob('wallet_address/wallet_address.php') as $wallet_address){include_once $wallet_address;}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>BitMerchants | Payment Wallet</title>
  <!-- Favicon icon -->
          ...
          <div class="col-md-12">
            ...
            <div class="card bg-dark shadow-lg">
              <div class="card-header header-elements-inline bg-transparent">
                <h3 class="mb-0 text-yellow font-20 pt-3 pr-2 pl-2">Set Your Crytocurencies Wallet Addresses.</h3>
                <h5>To omit anyone, add ******** in the input and the sytem will ignore</h5>
              </div>
              ...
              <div class="card-body">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                  ...
                  <div class="form-group row p-2">
                    <label class="col-form-label col-lg-2 text-white font-16">Enter Bitcoin Wallet address</label>
                    <div class="col-lg-10">
                      <input type="text" name="bitcoin" class="form-control bg-dark text-white pt-4 pb-4 rounded" value="<?php echo $bitcoin; ?>" >
                    </div>
                  </div>
                  <div class="form-group row p-2">
                    <label class="col-form-label col-lg-2 text-white font-16">Enter Etherum Wallet address</label>
                    <div class="col-lg-10">
                      <input type="text" name="ethereum" class="form-control bg-dark text-white pt-4 pb-4 rounded"
                        value="<?php echo $ethereum; ?>" >
                    </div>
                  </div>
                  <div class="form-group row p-2">
                    <label class="col-form-label col-lg-2 text-white font-16">Enter BNB Wallet address</label>
                    <div class="col-lg-10">
                      <input type="text" name="bitcoin_cash" class="form-control bg-dark text-white pt-4 pb-4 rounded"
                        value="<?php echo $bitcoin_cash; ?>" >
                    </div>
                  </div>
                  <div class="form-group row p-2">
                    <label class="col-form-label col-lg-2 text-white font-16">Enter USDT Wallet address</label>
                    <div class="col-lg-10">
                      <input type="text" name="litecoin" class="form-control bg-dark text-white pt-4 pb-4 rounded"
                        value="<?php echo $litecoin; ?>" >
                    </div>
                  </div>
