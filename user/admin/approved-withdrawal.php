...
<head>
  ...
  <title>BitMerchants | Approved Withdrawals</title>
  <!-- Favicon icon -->
      ...
      <div class="container-fluid" id="dashboard">
        ...
        <div class="row py-4">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Approved Withdrawals</h4>

                     <?php foreach (glob('withdrawal_log/approved_withdrawal.php') as $approved_withdrawal){include_once $approved_withdrawal;}?>
