...
<head>
  ...
  <title>BitMerchants | All Investment</title>
  <!-- Favicon icon -->
      ...
      <div class="container-fluid" id="dashboard">
        ...
        <div class="row py-4">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
              <h3>Investments (<span class="feature-stat" style="color: #2F7AEA;">...</span>)</h3>
                <p>A completed investment that is marked "withdrawn" indicates that the user has withdrawn his profit to his BTC wallet</p>

                       <?php foreach (glob('investment/running_investment.php') as $running_investment){include_once $running_investment;}?>
...
<script type="module" defer src="<?php echo($js)?>adminInvest.js"></script>
  <script src="css/vendor/assets/libs/jquery/dist/jquery.min.js"></script>
