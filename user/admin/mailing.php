...
<head>
  ...
  <title>BitMerchants | Mailing</title>
  <!-- Favicon icon -->
...
<body>
        ...
        <!-- TradingView Widget END -->
                  ...
                  <div class="row py-5">
                    ...
                    <div>
                            ...
                            <button type="update" id="mail-btn" class="btn bg-dark text-white mail-btn">Mail all users<i class="icon-paperplane ml-2"></i></button>
                            </div>
                      <div class="card"> 
                        <div class="card-body" style="display: none;">
                          <h4 class="card-title">Your mail SMTP settings for email notifications and verification</h4>
                          ...
                          <br>
                                    ...
                                    <p>Customize your email template parameters like name, address, license number etc in "Setup".</p>

                                    <div class="form-group row" style="display: none;">
                                      <label class="col-form-label col-lg-2"> Name:</label>
                                      <div class="col-lg-3">
                                        <div class="input-group">
                                         <input type="email" value="null" id="name" class="form-control">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-form-label col-lg-2"> Server Username:</label>
                                      <div class="col-lg-3">
                                        <div class="input-group">
                                         <input type="email" value="<?php echo($username);?>" id="username" class="form-control">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-form-label col-lg-2"> Server Password:</label>
                                      <div class="col-lg-3">
                                        <div class="input-group">
                                         <input type="text" value="<?php echo($password);?>" id="password" class="form-control">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-form-label col-lg-2"> Server Host:</label>
                                      <div class="col-lg-3">
                                        <div class="input-group">
                                         <input type="text" value="<?php echo($host);?>" id="host" class="form-control">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-form-label col-lg-2"> Auth:</label>
                                      <div class="col-lg-3">
                                        <div class="input-group">
                                         <input type="text" value="<?php echo($auth);?>" id="auth" class="form-control">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      ...
                                      <div class="col-lg-3">
                                        <div class="input-group">
                                         <input type="text" value="<?php echo($security);?>" id="security" class="form-control">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-form-label col-lg-2"> Server Port:</label>
                                      <div class="col-lg-3">
                                        <div class="input-group">
                                         <input type="number" value="<?php echo($port);?>" id="port" class="form-control">
                                        </div>
                                      </div>
                                    </div>
                                    <br>
                                    <br>
                                    <div class="form-group row">
                                      <label class="col-form-label col-lg-2"> Admin Email for Notifications:</label>
                                      <div class="col-lg-3">
                                        <div class="input-group">
                                         <input type="email" value="<?php echo($adminemail);?>" id="adminemail" class="form-control">
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <button id="update-btn" type="update" class="btn bg-dark text-white update-btn">Update<i class="icon-paperplane ml-2"></i></button>
                                  </div>
  ...
  <script type="module" defer src="<?php echo($js)?>adminSmtp.js"></script>
  <script src="css/vendor/assets/libs/jquery/dist/jquery.min.js"></script>
