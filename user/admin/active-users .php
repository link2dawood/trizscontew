...
<head>
  ...
  <title>BitMerchants | Blocked Account</title>
  <!-- Favicon icon -->
          ...
          <ul id="sidebarnav" class="bg-bitmine mt-4">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link has-arrow waves-effect waves-dark nav__link" href="javascript:void(0)"
                aria-expanded="false">
                <span class="iconify nav__icon font-16" data-icon="mdi-account-group"></span><span
                  class="hide-menu ">Clients
                  Management</span></a>
              <ul aria-expanded="false" class="collapse  first-level color-collapse">
                <li class="sidebar-item"><a href="active-users" class="sidebar-link nav__link"> <span
                      class="iconify nav__icon font-16" data-icon="mdi-account-check-outline"></span>
                    </i><span class="hide-menu"> Registered users </span></a></li>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link nav__link" href="setup"
                aria-expanded="false">
                <ion-icon name="people" class="nav__icon"></ion-icon><span class="hide-menu">Setup</span>
              </a>
            </li>

            <li class="sidebar-item">
              <a class="sidebar-link waves-effect waves-dark sidebar-link nav__link" href="support-tickets"
                aria-expanded="false">
                <ion-icon name="chatbox-ellipses" class="nav__icon"></ion-icon><span class="hide-menu">Support
                  Tickets</span>
              </a>
            </li>
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse  first-level color-collapse">
                ...
                <li class="sidebar-item"><a href="approved-deposit" class="sidebar-link nav__link"><span
                      class="iconify nav__icon font-16" data-icon="mdi-cash-check"></span>
                    </i><span class="hide-menu"> Approved Deposits </span></a></li>
                <li class="sidebar-item"><a href="declined-deposit" class="sidebar-link nav__link"><span
                      class="iconify nav__icon font-16" data-icon="mdi-cash-remove"></span><span class="hide-menu">
                      Declined Deposits</span></a></li>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  ...
                  <table id="lang_opt" class="table table-striped table-bordered display" style="width:100%">
                    ...
                    <tbody>
                      <tr data-row-id="56">
                        <td><a href="#" data-toggle="modal" data-target="#responsive-modalUser56"
                            title="click to view details">USER04456</a></td>
                        <!-- modal content for user info -->
                        <div id="responsive-modalUser56" class="modal fade" tabindex="-1" role="dialog"
                          aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-body">
                                <form action="#" method="post">
                                  <input type="hidden" name="_token" value="x7as2Ai3yRWRkQArQA7iPbbdFtogL5KrOMiPpyRY">

                                  <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Name:</label>
                                    <div class="col-lg-10">
                                      <input type="text" name="name" class="form-control" value="ppppppppp">
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                      <input type="email" name="email" class="form-control" readonly
                                        value="yegan19132@yunchali.com">
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    <label class="col-form-label col-lg-2">Mobile:</label>
                                    <div class="col-lg-10">
                                      <input type="text" name="mobile" class="form-control" value="+351911111111">
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                      <div class="input-group">
                                        ...
                                        <input type="number" name="balance" step="any" max-length="10" value="0.000007"
                                          class="form-control">
                                      </div>
                                    </div>
                                  </div>
                        ...
                        <!-- /.modal -->
                        <td>obi chukwualuka</td>
                        <td>chuksello213@gmail.com</td>
                        <td>08164556302</td>
                        <td>0.006868 BTC</td>
                        <td style="color: #8F3739"><span
                            style="background:#00b33c;color: #FFF;padding: 3px 5px;border-radius:5px;">Active</span>
                        </td>
                        <td>August 14, 2020 4:14 pm</td>
                        <td>
                          <a class="remove-row pull-right" href="#"
                            onclick="var x = confirm('are you sure to unblock user?'); if(x){document.getElementById('block139').submit();}"><i
                              class="fas fa-check" title="UnBlock User"></i></a>

                          <a class="remove-row pull-right ml-3" href="#" title="Delete User"
                            onclick="event.preventDefault(); var x = confirm('are you sure to delete user?'); if(x){document.getElementById('delete139').submit();} "><i
                              class="fas fa-trash"></i></a>
                          <form action="#" method="POST" id="block139" style="display: none;">
                            <input type="hidden" name="_token" value="Ws0pAOunDGm4lmU8Zd8Y963qwXgW4C9D0OEkevSu"> <input
                              type="hidden" name="user_id" value="139">
                          </form>
                          <form action="#" method="POST" id="delete139" style="display: none;">
                            <input type="hidden" name="_token" value="Ws0pAOunDGm4lmU8Zd8Y963qwXgW4C9D0OEkevSu"> <input
                              type="hidden" name="user_id" value="139">
                          </form>
                        </td>
