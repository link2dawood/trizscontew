...
<head>
  ...
  <title>BitMerchants | Verification</title>
  <!-- Favicon icon -->
...
<body>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div style="display: flex; justify-content: space-between;">
                            ...
                            <button type="update" id="rest-btn" class="btn bg-dark text-white update-btn">Set restictions for unverified users<i class="icon-paperplane ml-2"></i></button>
                            </div>
                          </div>
                                    ...
                                    <?php foreach(glob('users/verif_users.php') as $users){include_once $users;}?>
                                  </div>
                      </div>
  ...
  <script type="module" defer src="<?php echo($js)?>adminVerification.js"></script>
  <script src="css/vendor/assets/libs/jquery/dist/jquery.min.js"></script>
