...
<head>
  ...
  <title>BitMerchants | Buy/Sell logs</title>
  <!-- Favicon icon -->
...
<body>
      ...
      <div class="container-fluid" id="dashboard">
        ...
        <div class="row py-4">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h3>Buy/Sell (<span class="feature-stat" style="color: #2F7AEA;">...</span>)</h3>

                  <h4 class="card-title">Buy/Sell Logs</h4>

                         <?php foreach (glob('buysell/list_buysell.php') as $list_buysell){include_once $list_buysell;}?>
  ...
  <script type="module" defer src="<?php echo($js)?>adminBuysell.js"></script>
  <script src="css/vendor/assets/libs/jquery/dist/jquery.min.js"></script>
