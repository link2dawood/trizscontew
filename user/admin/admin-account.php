...
session_start();
  ...
  foreach (glob('account/change_pass.php') as $change_pass){include_once $change_pass;}
...
<head>
  ...
  <title>BitMerchants | Admin-Account</title>
  <!-- Favicon icon -->
          ...
          <div class="col-md-10 col-sm-12 center">
            <div class="card bg-dark pt-4 pb-4 rounded-lg">
              <div class="card-header header-elements-inline">
                <h3 class="mb-0 text-white font-20">Administrator Information</h3>
              </div>
              <div class="card-body">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                  ...
                  <input type="hidden" name="id" value="<?php echo $_SESSION['id']; ?>">
                    ...
                    <label class="col-form-label col-lg-3 text-white font-16">Email Address</label>
                    <div class="col-lg-9">
                      <input type="email" name="email" value="<?php echo($email) ?>" readonly 
                        class="form-control bg-dark text-white"
                        style="padding:1.4rem !important; border-radius: 5px; border-color: blanchedalmond;" required>
                    </div>
                  </div>
                  <div class="form-group row p-2">
                    <label class="col-form-label col-lg-3 text-white font-16">Old Password</label>
                    <div class="col-lg-9">
                      <input type="password" name="old_pass" class="form-control bg-dark text-white"
                        style="padding:1.4rem !important; border-radius: 5px; border-color: blanchedalmond;" required>
                        <span class="text-yellow" ><?php echo $old_pass_err; ?></span>
                    </div>
                  </div>
                  <div class="form-group row p-2">
                    <label class="col-form-label col-lg-3 text-white font-16">New Password</label>
                    <div class="col-lg-9">
                      <input type="password" name="new_password" 
                        class="form-control bg-dark text-white"
                        style="padding:1.4rem !important; border-radius: 5px; border-color: blanchedalmond;" required>
                        <span class="text-yellow" ><?php echo $new_password_err; ?></span>
                    </div>
                     </div>
                  <div class="form-group row p-2">
                    <label class="col-form-label col-lg-3 text-white font-16">Confirm Password</label>
                    <div class="col-lg-9">
                      <input type="password" name="confirm_password" 
                        class="form-control bg-dark text-white"
                        style="padding:1.4rem !important; border-radius: 5px; border-color: blanchedalmond;" required>
                        <span class="text-yellow" ><?php echo $confirm_password_err; ?></span>
                    </div>
                  </div>
                  <div class="text-right">
                    <button name="update" type="submit" class="btn btn-default bg-white text-gray-dark bold">Submit</button>
                  </div>
                </form>
              </div>
            </div>
