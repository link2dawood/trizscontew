...
<head>
  ...
  <title>BitMerchants | Payment Gateway settings</title>
  <!-- Favicon icon -->
          ...
          <div class="col-md-12">
            ...
            <div class="card bg-dark shadow-lg">
              <div class="card-header header-elements-inline bg-transparent">
                <h3 class="mb-0 text-yellow font-20 pt-3 pr-2 pl-2">Go to <a style="text-decoration: underline;" href="settings">settings</a> to choose your payment gateway</h3>
                <h5 class="mb-0 text-white font-20 pt-3 pr-2 pl-2" style="font-size: 13px; color: #fff;">Manage public and private keys directly in code: 'user/bundle/payment'</h5>
              </div>
